...
Simply <a href="https://s3-eu-west-1.amazonaws.com/apigatewaycloudformation/builds/v1.1.0.zip">download the installation package from the CDN</a>, unzip it and run the following command from your shell:
