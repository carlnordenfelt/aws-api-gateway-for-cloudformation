...
var ApiBasePathMappingService = require('../service/api-base-path-mapping/api-base-path-mapping-service');
var ApiBasePathMappingEvent = require('../service/api-base-path-mapping/api-base-path-mapping-event');
