...
pub.deleteResource = function deleteResource(event, context, eventParams, callback) {
    CloudFormationResourceTracker.get(event, context, function (getError, apiResourceEntry) {
        ...
        if (apiResourceEntry) {
            ApiResourceService.deleteResource(apiResourceEntry.resourceIdentifier, eventParams.params.restApiId, function (deleteError) {
                if (deleteError) {
...
pub.updateResource = function updateResource(event, context, eventParams, callback) {
    CloudFormationResourceTracker.get(event, context, function (getError, apiResourceEntry) {
        ...
        if (apiResourceEntry) {
            ApiResourceService.patchResource(apiResourceEntry.resourceIdentifier, eventParams.params.restApiId, eventParams, function (patchError) {
                if (patchError) {
