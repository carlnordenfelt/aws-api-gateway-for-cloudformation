...
var ApiResourceService = require('../api-resource/api-resource-service');
var RestApiEvent = require('./rest-api-event');
...
pub.createApi = function createApi(inputParams, callback) {
    ...
    awsApiGateway.createRestApi(params, function (error, restApi) {
        ...
        ApiResourceService.getApiParentResource(restApi.id, function (getResourceError, parentResource) {
            ...
            } else if (inputParams.corsConfiguration) {
                CorsService.putOptionsMethod(restApi.id, parentResource.id, inputParams.corsConfiguration, function (corsError) {
                    if (corsError) {
